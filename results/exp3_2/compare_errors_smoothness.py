...
# ---Metriken-Textbox auf dem Plot (MIT VERGLEICH) ---
metrics_text = (
...
# Platziere die Textbox oben links auf dem Plot
ax.text(0.05, 0.95, metrics_text,
        transform=ax.transAxes,
        fontsize=9, # Ggf. Schriftgröße anpassen
        verticalalignment='top',
        fontfamily='monospace', # Wichtig für die Tabellen-Ausrichtung
